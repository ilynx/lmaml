...
namespace LMaML.FMOD
{
    ...
    public class AudioChannel : ComponentBase, IChannel
    {
        ...
        private void Init()
        {
            ...
            if (RESULT.OK != result)
                throw AudioPlayer.GetException("Unable to get sound defaults", result);
            SampleRate = freq;
        }
        ...
        private static uint GetLength(Sound fmodSound, TIMEUNIT unit)
        {
            ...
            if (RESULT.OK != result)
                throw AudioPlayer.GetException("Unable to get length of sound", result);
            return length;
        }
        ...
        {
            if (RESULT.OK != result)
                throw AudioPlayer.GetException("Unable to get fft", result);
        }
        ...
        public double CurrentPosition
        {
            get
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to get current sound position", result);
                return position;
            }
        }
        ...
        public float Volume
        {
            get
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to get current channel volume", result);
                return vol * 100f;
            }
            set
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to set channel volume", result);
            }
        }
        ...
        public void Seek(double offset)
        {
            ...
            if (RESULT.OK != result)
                throw AudioPlayer.GetException("Unable to seek in this channel", result);
        }
        ...
        private static Channel CreateChannel(global::FMOD.System system, Sound sound)
        {
            ...
            if (result != RESULT.OK)
                throw AudioPlayer.GetException("Unable to play sound", result);
            return channel;
        }
        ...
        public bool IsPaused
        {
            get
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to get paused value from channel", result);
                return val;
            }
            set
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to get paused state", result);
        ...
        public bool IsPlaying
        {
            get
            {
                ...
                if (RESULT.OK != result)
                    throw AudioPlayer.GetException("Unable to get playing value from channel", result);
                return val;
            }
        }
